		...
		<div class="container">
			...
			<form method="post" class="login-form">
				<div class="input-group mb-3">
					<label>아 이 디</label>&nbsp;
					<input type="email" class="form-control radius" placeholder="아이디를 입력하세요">
				</div>
				<div class="input-group mb-3">
					<label>전화번호</label>
					<input type="email" class="form-control radius" placeholder="전화번호를 입력하세요">
				</div>
				<p style="text-align: center;">────────────── 또는 ─────────────</p>
				<div class="input-group mb-3">
					<label>이　　름</label>
					<input type="email" class="form-control radius" placeholder="이름을 입력하세요">
				</div>
				<div class="input-group mb-3">
					<label>이 메 일</label>&nbsp;
